...
# Project:  SFML.pro
# Template: app
# Command: /usr/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile SFML.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = SFML1.0.0
DISTDIR = /home/ivan/ClionProjects/SFML/.tmp/SFML1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -lBox2D -ltinyxml -lsfml-graphics -lsfml-window -lsfml-audio -lsfml-system 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: SFML.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		SFML.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile SFML.pro
...
rectangleobject.o: rectangleobject.cpp rectangleobject.h \
		Object.h \
		exception.h \
		circleobject.h \
		polygonobject.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o rectangleobject.o rectangleobject.cpp
...
circleobject.o: circleobject.cpp circleobject.h \
		Object.h \
		exception.h \
		polygonobject.h \
		rectangleobject.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o circleobject.o circleobject.cpp
